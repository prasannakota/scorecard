...
import ModuleBreakdownDescription from "@/components/result/ModuleBreakdownDescription";
import PendingModuleSection from "@/components/result/PendingModuleSection";
  ...
  return (
      <div className=" ">
       ...
       <div className="bg-white p-6">
            <ResultBanner />
            <SummarySection />
            <ModuleBreakdownDescription />
            <PendingModuleSection  />
