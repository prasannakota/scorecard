...
export default function Home() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-white ">
      <div className="w-full md:max-w-[1400px] flex flex-col md:flex-row gap-16 bg-white md:p-[32px]">
        ...
        <div className="hidden md:flex flex-col items-center text-center md:w-[50%]">
          ...
          {activeTab === "register" && (
              ...
              >
                  ...
                  <h1
                      id="hero-title"
                      className="absolute bottom-40 self-stretch w-[80%] left-[50%] translate-x-[-50%] text-4xl font-black tracking-tighter text-center text-white  max-md:max-w-full leading-[54px]"
                  >
                       Boost Your Commerce Success with Data-Driven Insights!
                  </h1>
        ...
        <div className='loginscreen py-[40px] px-[20px] md:w-[50%]'>
          <div className='logo mb-[30px] md:mb-[50px]'>
            ...
            <TabsList className="grid grid-cols-2 mb-8 p-1 bg-gray50">
              ...
              <TabsTrigger value="register" className="flex items-center justify-center gap-2 px-3 md:px-5 rounded-md py-2 text-sm md:!text-base">
                Create an Account
              </TabsTrigger>
               {/*<a
                    href="/admin-login"
                    ...
                    className="flex items-center justify-center gap-2 text-sm md!text-base px-3 md:px-5 py-2 rounded-md transition-colors"
                >
                    Admin Login
                </a> */}
