...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Create Assessment') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('assessment.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="score" type="number" class="form-control @error('score') is-invalid @enderror" name="score" value="{{ old('score') }}" required min="0" max="100">
